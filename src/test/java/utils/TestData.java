...
public final class TestData {
    ...
    public static final long GET_RESPONSE_TIME_LIMIT_MS = 2500L;
    public static final long POST_RESPONSE_TIME_LIMIT_MS = 3500L;
    public static final long DELETE_RESPONSE_TIME_LIMIT_MS = 3000L;
